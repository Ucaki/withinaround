...
export default function CourseLandingPage() {
                            ...
                            <div className="relative pb-[30px]">
                                ...
                                <div className="bg-gradient-to-b from-transparent to-gray-400 pt-[30px] pb-[10px]">
                                    <div className="max-w-[1170px] mx-auto">
                                        ...
                                        <div className="font-openSans w-auto md:w-[70%] max-w-full text-black text-[20px] md:text-[28px] leading-[1.5em] font-medium text-center px-[35px] py-[20px] mt-[10px] mx-auto whitespace-pre-wrap">Discover the research-backed approach that addresses the root cause of desk-related tightness - where small, daily practices create lasting change without force or strain
                                            </div>
                                            </div>
                                            </div>
                                            </div>
    ...
    <form id="signup" method="POST" className="block w-full max-w-[580px] mt-[30px] mx-auto lg:px-[20px]" style={{color: '#FFF'}} >
        <input type="text" className="rounded-md bg-white py-2 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 font-[400] text-black text-lg leading-[130%] block mx-auto w-full h-[64px] border-solid border-[#B1B1B1] border-[2px] text-left px-[16px]" name="first_name" placeholder="Enter your first name" />
        <input type="text" className="rounded-md bg-white py-2 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 font-[400] text-black text-lg leading-[130%] block mx-auto w-full h-[64px] border-solid border-[#B1B1B1] border-[2px] text-left mt-[20px] px-[16px]" name="email" placeholder="Enter your email" />
        <button type="submit" className="flex flex-col justify-center items-center w-full min-h-[80px] rounded-full mt-[20px] px-[20px] py-[10px] shadow-[3px_3px_0px_1px_rgba(0,0,0,0.25)] hover:opacity-90" style={{backgroundColor: '#F8E16C' , color : '#363636'}}>
            <span className="font-bold title-3">CLAIM YOUR FREE ACCESS</span><span className="headline">Limited Availability</span></button>
        <div className="font-openSans footnote text-center mt-[20px] whitespace-pre-wrap opacity-60">I respect your privacy. We never share your information.
            </div>
    </form>
            </div>
            </div>
            </div>
            <div className="py-[65px]" style={{background: '#FFF'}}>
                <div className="md:max-w-[1170px] flex flex-col md:flex-row px-[5px] md:px-[10px] items-center justify-center mx-auto">
        ...
        <div className="flex-1"><div className="text-[20px] md:text-[32px] leading-[1.3em] font-black text-white headline bg-[#363636] px-[30px] py-[20px]">WHAT WORKS INSTEAD
            </div>
            <div className="font-openSans font-normal text-[16px] md:text-[18px] p-[25px]">Gentle techniques that target the real problem. Quick and effective.
                </div>
                </div>
                </div>
                </div>
                <div className="w-full lg:max-w-[40%] flex-1 md:basis-0 bg-[#F2F2F2] rounded-lg overflow-hidden my-[20px] mx-[15px] md:mx-[10px] lg:mx-[15px]">
                    <div className="flex-col items-center text-center">
                        ...
                        <div style={{position: 'relative' , width: '100%' , paddingBottom :' 56.25%' }}>
                            ...
                            <div className="flex-1">
                                <div className="text-[20px] md:text-[32px] leading-[1.3em] font-black text-white headline bg-[#363636] px-[30px] py-[20px]">YOUR STEP-BY-STEP PLAN
                                    </div>
                                    <div className="font-openSans font-normal text-[16px] md:text-[18px] p-[25px]">Exactly what to do each week. Built for busy schedules.
                                        </div>
                                        </div>
                                        </div>
                                        </div>
            ...
            <div className="font-openSans text-[18px] md:text-[30px] leading-[1.3em] font-normal text-[#363636] text-center mx-auto whitespace-pre-wrap mt-[15px]">When traditional stretching fails, this approach works. Designed specifically for professionals who spend their days sitting.
                ...
                <div className="max-w-[1170px] flex flex-col md:flex-row mx-auto px-[5px] md:px-[10px] pb-[20px]">
                <div className="flex flex-col flex-1 basis-0 w-full md:px-[20px]">
                    <div className="mt-0">
    ...
    <div className="px-0">
        <a href="#signup" className="flex flex-col justify-center items-center w-full max-w-[580px] min-h-[80px] text-center rounded-full mt-[30px] px-[20px] py-[10px] mx-auto shadow-[3px_3px_0px_1px_rgba(0,0,0,0.25)] hover:opacity-90" style={{backgroundColor: '#F8E16C', color: '#363636'}}>
        <span className="font-extrabold text-2xl tracking-tight font-[Roboto]">GET FREE ACCESS </span>
        <span className="text-2xl">Limited Time Only - Start Today</span>
        </a>
        </div>
                ...
                <div style={{position:'relative', width:'100%', paddingBottom:'133.33333333333334%'}}>
                    <div className="relative inset-0">
                        ...
                        {/*<picture>
                            ...
                            <div className="flex-1 basis-0 hidden md:block md:mt-[10px]">
                                <div className="rounded-[10px] mx-[20px] overflow-hidden">
                                    <div style={{position:'relative', width:'100%', paddingBottom:'133.33333333333334%'}}>
                                        <div style={{position:'absolute' , top: '0', right: '0', bottom: '0', left: '0'}}>
                                            <picture>
                                                <source srcSet="https://studiocdn.doyou.com/withinnaround/join/cta-sxdme0.webp" type="image/webp" />
                                                                            ...
                                                                            <div className="flex flex-col w-full max-w-[1170px] py-[20px] mx-auto ">
                                                                                ...
                                                                                <div className="w-full flex flex-wrap justify-center items-center mt-[15px]">
                                                                                    ...
                                                                                    <div className="pt-16 pb-10 px-3 md:px-6 bg-[#F5F5F5] text-[#7D7D7D]">
                                                                                        ...
                                                                                        <ul className="font-openSans flex items-center justify-center gap-4 opacity-70">
                                                                                            <li><a href="mailto:dimitrijemilenkovic.dm@gmail.com" target="_blank">Support</a></li>
